...
void iDraw()
{
		...
		if( x+36>=r2x && x+36<=r2x+30 && y<=300 ||
		x>=r2x && x<=r2x+30 && y<=300 ||

		x+36>=r1x && x+36<=r1x+30 && y+36>=r1y ||
		x>=r1x && x<=r1x+30 && y+36>=r1y ||

		x+36>=r4x && x+36<=r4x+30 && y<=180 ||
		x>=r4x && x<=r4x+30 && y<=180 ||

		x+36>=r3x && x+36<=r3x+30 && y+36>=r3y ||
		x>=r3x && x<=r3x+30 && y+36>=r3y ||

		x+36>=r5x && x+36<=r5x+30 && y<=262 ||
		x>=r5x && x<=r5x+30 && y<=262 ||

		x+36>=r6x && x+36<=r6x+30 && y+36>=r6y ||
		x>=r6x && x<=r6x+30 && y+36>=r6y || y==0)
	{
		game=5;
	}
		if(game==5)
